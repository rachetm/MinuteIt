...
if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
    ...
    <head>
        ...
        <title>MinuteIt • New Circular</title>
    ...
    <body onload="new_meeting(); disable(); pseudo(<?php echo $_SESSION['error']; ?>,'circular');">
        <?php
        include "navbar.php";
        include "modals.php";
        ?>
        ...
        <div class="container">
            ...
            <div class="input-group container">
                <form action="save_circular.php" method="post">
                    <div class="form-row">
                        <div class="col-lg-6">
                            <div class="col-lg-4 col-sm-12 col-md-12">
                                <label class="meet_form_label" for="datepick" class="input-custom"><b>Circular Date</b></label>
                            </div>
                            <div class="col-lg-7 col-sm-12 col-md-12">
                                <input class="form-control" type="date" value="<?php echo date("Y-m-d"); ?>" name="cdatepick" id="cdate" required="">
                            </div>
                        </div>
                        <div class="form-row margin-top">
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 col-sm-12 col-md-12">
                                    <textarea class="form-control" name="agenda" id="agenda" cols="135" rows="12" required autofocus></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-row margin-top">
                            ...
                            <div class="col-lg-4 mt-2">
                                <div class="col-lg-12 col-sm-12 col-md-12">
                                    <label class="meet_form_label" for="datepick" class="input-custom"><b>Meeting Date</b></label>
                                </div>
                                <div class="col-lg-12 col-sm-12 col-md-12">
                                    <input class="form-control" type="date" name="mdatepick" id="mdate" required="">
                                </div>
                            </div>
                            <div class="col-lg-4 mt-2">
                                <div class="col-lg-12 col-sm-12 col-md-12">
                                    <label class="meet_form_label" for="timepick" class="input-custom" style="padding-right: 2px;"><b>Meeting Time</b></label>
                                </div>
                                <div class="col-lg-12 col-sm-12 col-md-12">
